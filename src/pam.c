...
// callback called each time we're talking to pam
...
int pam_authenticate_user(const char *username, const char *password)
{
	...
	// check user:password against pam
